...
class Config:
    ...
    # CORS
    # Mobil için: Expo Go (http://10.0.2.2 Android emulator, http://192.168.x.x gerçek cihaz)
    CORS_ORIGINS = [
        'http://localhost:5173',
        'http://localhost:5174',
        'http://localhost:3000',
        'http://10.0.2.2:5000',
        'http://10.0.2.2:8081',
        'https://dental-ai-web-beta.vercel.app',
        'https://dental-ai-955relbrn-mertkrgl02-8625s-projects.vercel.app',
    ]
